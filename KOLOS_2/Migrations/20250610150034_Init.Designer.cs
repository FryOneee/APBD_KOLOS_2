...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KOLOS_2.Models.Race", b =>
                {
            ...
            modelBuilder.Entity("KOLOS_2.Models.RaceParticipation", b =>
                {
            ...
            modelBuilder.Entity("KOLOS_2.Models.Racer", b =>
                {
                    b.Property<int>("RacerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KOLOS_2.Models.Track", b =>
                {
            ...
            modelBuilder.Entity("KOLOS_2.Models.TrackRace", b =>
                {
                    b.Property<int>("TrackRaceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KOLOS_2.Models.RaceParticipation", b =>
                {
                    b.HasOne("KOLOS_2.Models.Racer", "Racer")
                        .WithMany("RaceParticipation")
                        .HasForeignKey("RacerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KOLOS_2.Models.TrackRace", "TrackRace")
            ...
            modelBuilder.Entity("KOLOS_2.Models.TrackRace", b =>
                {
                    b.HasOne("KOLOS_2.Models.Race", "Race")
                        .WithMany("TrackRaces")
                        .HasForeignKey("RaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KOLOS_2.Models.Track", "Track")
                        .WithMany("TrackRaces")
